...
class Francis:
    def __init__(self):
        self.role     = "CS Undergrad @ RVU '25"
        self.location = "India · UTC+05:30"
        self.focus    = ["Computer Vision", "Accessibility", "Healthtech"]
        self.langs    = ["TypeScript", "Python", "JavaScript", "SQL"]
        self.mindset  = "Start with a real problem. Ship early. Iterate."

    def current(self):
        return "Applying ML + CV to problems people actually have."
```
